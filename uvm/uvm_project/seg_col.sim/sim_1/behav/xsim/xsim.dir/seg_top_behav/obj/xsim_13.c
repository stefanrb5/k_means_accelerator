...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x44c1a0)) ;
...
extern "C" {
	...
	extern void subprog_m_d7fc2a63_556ead11_2253(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 1027616, 168, 239600) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_d7fc2a63_556ead11_2253), IP) ;
